...
as_of: 2026-05-29
audience: [self]
one_line_thesis: "788Dで起きたLCD反り問題の経緯。825D(ミネベア貼合)では発生せず確認済み、788D側は調査継続中。"
confidence: medium
relations:
...
**788D（ホシデン貼合）で起きた「LCD反り→貼付不可」を起点に 825D への波及を確認した経緯。結論として 825D（ミネベアミツミ貼合）では反り問題は発生せず（社内・ミネベアミツミで確認済み）、788D 側は結論未確定で調査継続中（天馬液晶の動向を要ウォッチ）。**

> 📌 レビュー反映（2026-05, ENDO）: 825D での非発生・確認済み、788D 継続調査・天馬液晶ウォッチ要。以下 L2 は当時の調査時点（〜2026-03）の記録。
...
- **825D の結論**: ミネベアミツミ貼合では反り問題は発生せず（社内・ミネベアミツミで確認済み）
- **788D の現況**: 結論未確定で調査継続中。今後の天馬液晶の動向を要ウォッチ
